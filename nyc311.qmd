...
nyc_flood_feather['request_hour'] = nyc_flood_feather['created_time'].dt.hour


nyc_flood_feather['rush_hour'] = ((nyc_flood_feather['request_hour'] >= 7) & (nyc_flood_feather['request_hour'] <= 9)) | ((nyc_flood_feather['request_hour'] >= 16) & (nyc_flood_feather['request_hour'] <= 19))

nyc_flood_feather['weekend'] = nyc_flood_feather[]

nyc_flood_feather['weekday']
