...
# Set the bins to the appropriate values
bins = list(np.arange(0, nyc_flood_feather['response_time_hours'].max() + 6, 6))


histogram = (
    ggplot(nyc_flood_feather, aes(x='response_time_hours'))
    + geom_histogram(bins=bins, fill='blue', color='white', alpha=0.5)
    + labs(
        title='Response Times by Complaint Type and Borough',
