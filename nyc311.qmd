...
nyc_flood_feather['close_date'] = pd.to_datetime(nyc_flood_feather['closed_date'])
...
dating_error_count = nyc_flood_feather[nyc_flood_feather['closed_date'] < nyc_flood_feather['created_date']].sum()
